...
Route::get('guest/search/{id}','ShopInformation\ShopInformationController@GuestSearchById');
...
Route::get('shopName/show','ShopInformation\ShopInformationController@shopNameShow');
...
Route::resource('/smsApiInfo','SmsApiInfoController');
Route::resource('/simOperator','SimOperatorController');
Route::resource('/simType','SimTypeController');
Route::resource('/smsTemplateInfo','SmsTemplateInfoController');
// road entry
...
Route::get('allRoadList','ShopInformation\ShopInformationController@allRoadList');
