(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["salesReturnApporved@report"],{

/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    salesInvoiceEntry: function salesInvoiceEntry() {
      ...
      //  salesDueCollection
      this.form.post("/salesReturnBillReceive").then(function (res) {
        Toast.fire({
          icon: "success",
    ...
    setupInvoiceAmount: function setupInvoiceAmount(e) {
      ...
      axios.get("/salesReturnCustomerDue/" + e).then(function (res) {
    ...
    colorList: function colorList() {
      ...
      axios.get("/colorListAll").then(function (res) {
        _this8.colorLists = res.data.colorList;
      });
    },
    sizeList: function sizeList() {
      ...
      axios.get("/sizeListAll").then(function (res) {
        _this9.sizeLists = res.data.sizeList;
      });
    },
    productSupplierList: function productSupplierList() {
      var _this10 = this;

      axios.get("/salesApprovedReturnInvoice").then(function (res) {
        _this10.purchaseInvoiceReports = res.data.purchaseInvoiceReports;
      });
    },
    productBrandList: function productBrandList() {
      ...
      axios.get("/productBrandList").then(function (res) {
        _this11.allProductBrandLists = res.data.productBrandList;
      });
    },
    getPaginateList: function getPaginateList() {
      ...
      axios.get("/salesApprovedReturnInvoice?page=" + page).then(function (response) {
        _this12.purchaseInvoiceReports = response.data.purchaseInvoiceReports;
      });
    },
    getInvoiceSetupInformation: function getInvoiceSetupInformation() {
      ...
      axios.get(uri).then(function (response) {
        _this13.gets = response.data.data;
      });
    },
    viewInvoiceInfo: function viewInvoiceInfo(id) {
      var _this14 = this;

      var uri = 'salesReturnInvoiceInfo/' + id;
      axios.get(uri).then(function (response) {
        _this14.unitLists = response.data.unitList;
        _this14.countryLists = response.data.countryList;
        _this14.purchaseTypes = response.data.purchaseType;
        _this14.productBrandLists = response.data.productBrandList;
        _this14.supplier_id = response.data.data.productSupplierId;
        _this14.invoiceInfo = response.data.data;
        _this14.invoiceProductLists = response.data.invoiceProductLists;

        if (response.data.supplierInfo) {
          _this14.supplierInfo = response.data.supplierInfo;
        }

        _this14.purchaseProductList = response.data.purchaseProductList;
      });
    }
  }
});
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e&":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e& ***!
  \************************************************************************************************************************************************************************************************************************************************/
              ...
              _c(
                ...
                _vm._l(_vm.purchaseInvoiceReports.data, function(
                  ...
                  return _c("tr", [
                    ...
                    _vm._v(" "),
                    _c("td", [
                      purchaseInvoiceReport.customer_name
                        ? _c("span", [
                            _vm._v(
                              " " +
                                _vm._s(
                          ...
                          on: {
                            click: function($event) {
                              return _vm.setupInvoiceAmount(
                                purchaseInvoiceReport.customerId
                              )
                            }
                          }
                        },
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("h4", [_vm._v(" Sales Return Approved ")])
          ]
        )
      ]
    )
...
/***/ "./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue":
/*!***********************************************************************************!*\
  !*** ./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue ***!
  \***********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./salesReturnApporved@report.vue?vue&type=template&id=80a8106e& */ "./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e&");
/* harmony import */ var _salesReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./salesReturnApporved@report.vue?vue&type=script&lang=js& */ "./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _salesReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************!*\
  !*** ./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_salesReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./salesReturnApporved@report.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_salesReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e&":
/*!******************************************************************************************************************!*\
  !*** ./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e& ***!
  \******************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./salesReturnApporved@report.vue?vue&type=template&id=80a8106e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/sales/sales@report/salesReturnApporved@report.vue?vue&type=template&id=80a8106e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_salesReturnApporved_report_vue_vue_type_template_id_80a8106e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
