(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["purchaseReturnApporved@report"],{

/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return {
      form: new Form((_ref = {
        ...
        receiverAcName: '',
        receiverBranchName: ''
      }, _defineProperty(_ref, "receiverBankName", ''), _defineProperty(_ref, "receiverAcNo", ''), _defineProperty(_ref, "receiverAcName", ''), _defineProperty(_ref, "receiverMobileAcNo", ''), _defineProperty(_ref, "receiverTrxNo", ''), _defineProperty(_ref, "senderbankTypeEntryId", ''), _defineProperty(_ref, "senderbankEntryId", ''), _defineProperty(_ref, "senderbankAccountId", ''), _defineProperty(_ref, "senderbranchName", ''), _defineProperty(_ref, "senderAccNo", ''), _defineProperty(_ref, "bankAmount", ''), _defineProperty(_ref, "returnInvoiceId", ''), _ref)),
  ...
  methods: {
    ...
    salesInvoiceEntry: function salesInvoiceEntry() {
      ...
      $('#btn-' + this.form.id).hide(); //  salesDueCollection
    ...
    getBankMoreInfo: function getBankMoreInfo() {
      ...
      axios.get("/bankAccountMoreInfo/" + this.form.receiverbankAccountId).then(function (res) {
        _this6.form.receiverbranchName = res.data.data.bankBranch;
        _this6.form.receiverAccNo = res.data.data.bankAccountNumber;
    ...
    // =========================== // payment system ========
    // ======================================================
    setupInvoiceAmount: function setupInvoiceAmount(e) {
      var _this7 = this;

      this.form.returnInvoiceId = e;
      axios.get("/purchaseReturnSupplierDue/" + e).then(function (res) {
        _this7.form.currentTotalAmount = Math.abs(res.data.supplierDue);
        _this7.form.currentDue = Math.abs(res.data.supplierDue);
      });
    },
    returnInvoiceApprove: function returnInvoiceApprove(e) {
      var _this8 = this;
    ...
    productSupplierList: function productSupplierList() {
      ...
      axios.get("/purchaseApprovedReturnInvoice").then(function (res) {
        _this11.purchaseInvoiceReports = res.data.purchaseInvoiceReports;
      });
    },
    productBrandList: function productBrandList() {
      ...
      axios.get("/productBrandList").then(function (res) {
        _this12.allProductBrandLists = res.data.productBrandList;
      });
    },
    getPaginateList: function getPaginateList() {
      ...
      axios.get("/purchaseApprovedReturnInvoice?page=" + page).then(function (response) {
        _this13.purchaseInvoiceReports = response.data.purchaseInvoiceReports;
      });
    },
    getInvoiceSetupInformation: function getInvoiceSetupInformation() {
      ...
      axios.get(uri).then(function (response) {
        _this14.gets = response.data.data;
      });
    },
    viewInvoiceInfo: function viewInvoiceInfo(id) {
      var _this15 = this;

      var uri = 'purchaseReturnInvoiceInfo/' + id;
      axios.get(uri).then(function (response) {
        _this15.unitLists = response.data.unitList;
        _this15.countryLists = response.data.countryList;
        _this15.purchaseTypes = response.data.purchaseType;
        _this15.productBrandLists = response.data.productBrandList;
        _this15.supplier_id = response.data.data.productSupplierId;
        _this15.invoiceInfo = response.data.data;
        _this15.invoiceProductLists = response.data.invoiceProductLists;

        if (response.data.supplierInfo) {
          _this15.supplierInfo = response.data.supplierInfo;
        }

        _this15.purchaseProductList = response.data.purchaseProductList;
      });
    }
  }
});
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a&":
/*!*********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a& ***!
  \*********************************************************************************************************************************************************************************************************************************************************/
              ...
              _c(
                ...
                _vm._l(_vm.purchaseInvoiceReports.data, function(
                  ...
                  return _c("tr", [
                    ...
                    _vm._v(" "),
                    _c("td", [
                      _vm._v(_vm._s(purchaseInvoiceReport.returnDate))
                    ]),
                    _vm._v(" "),
                    _c("td", [
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                  " +
                              _vm._s(purchaseInvoiceReport.returnInvoiceNo) +
                              "\n                "
                          )
                        ]
                      )
                    ...
                    _c("td", [
                      _c(
                        "button",
                        {
                          ...
                          attrs: {
                            type: "button",
                            id: "btnd-" + purchaseInvoiceReport.id
                          }
                        },
                        [_vm._v(" Collection ")]
                      ),
                      ...
                      _c(
                        "button",
                        {
                          ...
                          attrs: {
                            type: "button",
                            id: "btn-" + purchaseInvoiceReport.id,
                            "data-toggle": "modal",
                            "data-target": "#pay"
                          },
                          on: {
                            click: function($event) {
                              return _vm.setupInvoiceAmount(
                                purchaseInvoiceReport.productSupplierId
                              )
                            }
                          }
                        },
      ...
      [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("h4", [_vm._v(" Purchase Return Approved ")])
          ]
        )
      ]
    )
...
/***/ "./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue":
/*!********************************************************************************************!*\
  !*** ./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue ***!
  \********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a& */ "./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a&");
/* harmony import */ var _purchaseReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./purchaseReturnApporved@report.vue?vue&type=script&lang=js& */ "./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _purchaseReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js&":
/*!*********************************************************************************************************************!*\
  !*** ./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_purchaseReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./purchaseReturnApporved@report.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_purchaseReturnApporved_report_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a&":
/*!***************************************************************************************************************************!*\
  !*** ./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a& ***!
  \***************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/page/purchase/purchase@report/purchaseReturnApporved@report.vue?vue&type=template&id=0c1a8b1a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_purchaseReturnApporved_report_vue_vue_type_template_id_0c1a8b1a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
