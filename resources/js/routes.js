...
// Product Sale
    ...
    {
    path: '/data@entry',
    component: () => import(/* webpackChunkName: "data@entry" */'./admin/page/survay/data@entry.vue'),
...
//designation
   ...
   /* metting*/
    ...
    {
        path: '/smsApiConfigure',
        component: () => import(/* webpackChunkName: "smsApiConfigure" */'./admin/page/survay/smsApiConfigure'),
    
    },
    {
        path: '/smsTemplateInformation',
        component: () => import(/* webpackChunkName: "smsTemplateInfo" */'./admin/page/survay/smsTemplateInfo'),
    
    },
    {
        path: '/smsApiInfoEdit:id',
        component: () => import(/* webpackChunkName: "smsApiInfoEdit" */'./admin/page/survay/smsApiInfo'),
