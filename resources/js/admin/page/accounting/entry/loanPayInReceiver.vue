         ...
         <form @submit.prevent="create()">
              ...
              <router-link :to="`/loanManagement`" class="btn btn-primary"> 
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 <label> Interest Time Type <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                </label>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                 <label> {{paidDateText}} <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                </label>
...
<script>
    export default {
        ...
        methods: {
            create() {
              this.loading = true;
                this.form.post('/addReceiverLoanPay').then(res => {
                  this.loading = false;
