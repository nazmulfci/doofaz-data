        ...
        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
            ...
            <tbody>
              ...
              :key="voucherInformationList.id">
                ...
                <td> 
                  <span v-for="chartOfAccountRegisterList in chartOfAccountRegisterLists" v-if="chartOfAccountRegisterList.headCode==voucherInformationList.accountCodeDebit" class="border bg-light"> {{chartOfAccountRegisterList.headName}} </span> <br> 
                  <span v-for="chartOfAccountRegisterList in chartOfAccountRegisterLists" v-if="chartOfAccountRegisterList.headCode==voucherInformationList.accountCodeCredit" class="border bg-white"> {{chartOfAccountRegisterList.headName}} </span> 
                   </td>
...
this.form.voucherDate = moment().format("YYYY-MM-DD");
this.form.voucherNo = '';
