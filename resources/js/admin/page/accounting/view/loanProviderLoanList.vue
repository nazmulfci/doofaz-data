          ...
          <thead>
            ...
            <tbody>
              <tr v-for="(shopBankAllData, index) in shopBankAllDatas">
                    ...
                    {{getLoanPayTypeList.name}}
                      ...
                      <td>
                        ...
                        <span v-for="getInterestTimeTypeList in getInterestTimeTypeLists"
                              v-if="getInterestTimeTypeList.id==shopBankAllData.interestTimeType">
                ...
                <td>
                    <router-link :to="`/loanProviderLoanStatement${shopBankAllData.id}`" class="btn btn-hover-shine  btn-primary">
                ...
                <td>
                    <router-link :to="`/loanReceiveFromProviderEdit${shopBankAllData.id}`" class="btn btn-hover-shine  btn-primary">
                    Re-Loan </router-link>
                </td>
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.get(`getLoanProviderLoanList/${this.$route.params.id}`)
                    .then(res => {
