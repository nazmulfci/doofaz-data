...
<h4><i
          ...
          ></i>
          Statement of {{companyInformation.assetSupplierName}} </h4>
          </div>
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to"> {{ companyInformation.assetSupplierName }} </h2>
                        <div class="address"> {{ companyInformation.assetSupplierPhone }} </div>
                        <div class="address">{{ companyInformation.assetSupplierAddress }}</div>
                        <div class="email">
                          <a 
                          :href="'mailto:'+ companyInformation.assetSupplierMail " 
                         :style="'color:'+gets.themeColor">
                          {{ companyInformation.assetSupplierMail }}</a></div>
                    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr v-for="statementList,index in companyStatementLists">
                            ...
                            <td class="text-right"> {{statementList.creditAmount}} </td>
                            <td class="text-right"> 
...
export default {
  ...
  getInvoiceInformation() {
    ...
    let uri = `getAssetSupplierStatementInformation/${this.$route.params.id}`;
    axios.get(uri).then((response) => {
