...
getsubHeadCode() {
      ...
      axios.get(url)
        ...
        voucherSearch() {
          ...
          if(this.form.voucherDate){
            this.totalOrDaily = '('+moment(this.form.voucherDate).format("DD MMM YYYY")+' Expense Summary) ';
          }else{ 
            this.totalOrDaily = '(Total Expense Summary) ';
          }
      
      let url = 'expenseSummarySearch';
    ...
    showSubHeadCodeExpenseSummery(dat){
