...
<h4><i
          ...
          <span v-if="incomeExpenseCompanyInformation.providerType>1">
                                    {{ incomeExpenseCompanyInformation.providerName }}
                                    ({{ incomeExpenseCompanyInformation.providerBranchName }})
                                </span>
                                <span v-else="">
                                    {{ incomeExpenseCompanyInformation.providerName }} 
                                </span>
...
this.form.voucherNo = '';
    ...
    // alert(`${this.$route.params.id}`);
      let url = `getLoanProviderVoucherInformation/${this.$route.params.id}`;
      axios.get(url)
        .then((response) => {
