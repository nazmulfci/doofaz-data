  ...
  <span>
      <div class="card">
        <div class="card-header" style="background:rgba(221, 221, 221, 0.20);border:1px solid rgba(0, 0, 0, 0.05)">
             <h3 style="color:black">Brand With Product </h3>
         </div>
               ...
               <div class="col-lg-7 px-lg-5 col-sm-8 offset-sm-2 col-12  supplier-border">
                  <div class="form-group">
                     ...
                     >
                            ...
                            <option  v-for="(purchaseBrandList, index) in purchaseBrandLists"
                            v-if="purchaseBrandList.brand_name"
                            :value="purchaseBrandList.brandId">
                           {{ purchaseBrandList.brand_name.productBrandName }}</option>
                         </select>
