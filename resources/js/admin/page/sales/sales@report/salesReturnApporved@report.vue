        ...
        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
          ...
          <tbody>
            ...
            >
              <td>{{ index + 1 }}</td>
              <td>
               <span v-if=" purchaseInvoiceReport.customer_name"> {{
                  purchaseInvoiceReport.customer_name.customerName
                }}</span>
              </td>
...
<!--  -->
               ...
               class="btn btn-primary" data-toggle="modal"
                        :data-target="'#pay'"
               @click="setupInvoiceAmount(purchaseInvoiceReport.customerId)"
                > Collection </button>
                </td>
                                ...
                                <main>
                                  <div class="row contacts">
                                    <div class="col invoice-to">
                                      ...
                                      <div class="address">
                                        {{ supplierInfo.customerName }}
                                      </div>
                                      <div class="address">
                                        {{
                                          supplierInfo.customerPhone
                                        }}
                                      </div>
                                      ...
                                      <table class="table table-bordered">
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td class="bg-light">
                                              {{ invoiceInfo.previousPayableDue }}
                                            </td>
                                          </tr>
...
export default {
  ...
  methods: {
    ...
    // ======================================================
        ...
        this.form.post("/salesReturnBillReceive")
          .then((res) => {
            Toast.fire({
              icon: "success",
...
setupInvoiceAmount(e){
        ...
        axios.get("/salesReturnCustomerDue/"+e).then((res) => {
    ...
    productSupplierList() {
      axios.get("/salesApprovedReturnInvoice").then((res) => {
    ...
    getPaginateList(page = 1) {
      axios.get("/salesApprovedReturnInvoice?page=" + page).then((response) => {
    ...
    viewInvoiceInfo(id) {
      let uri = 'salesReturnInvoiceInfo/'+id;
      axios.get(uri).then((response) => {
