          ...
          <div class="col-md-2 numberList" v-if="role==3">
            ...
            <table style="width: 100%;" id="example" class="table table-bordered text-center">
                <thead>
                    ...
                    <th>Gallery</th>
                    <th>Metting</th>
                    <!-- <th>Permanent<span id="underscore_remove">_</span>Recycle</th> -->
                    <th width="10%">Edit</th>
                ...
                <tbody>
                    ...
                    <!-- <td>
                        <button id="btn_form" class="btn-sm btn-pill btn-info btn-hover-shine text-white">
                        Permanent Recycle
                        </button>
                    </td> -->
  ...
  nextPage() {
    ...
    CategoryEntryShow(){
      ...
      view() {
        ...
        axios.get('followup/recycle').then((response) => {
         this.searchInfoLook=false;
         //this.normalShows=true;
