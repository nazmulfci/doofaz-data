          ...
          <tbody>
            ...
            >
              ...
              <td>
               ...
               {{purchaseInvoiceReport.product_supplier_name.productSupplierName}}
                </span>
              </td>
              ...
              <td>
               ...
               class="btn btn-danger btnApproveLoading"> Approve </button>
<!--  -->
                <button type="button" 
               class="btn btn-primary btnApprove" 
               @click="setupInvoiceAmount(purchaseInvoiceReport.id)"
                > Approve </button>
                </td>
              <td>
               ...
               @click="deleteReturnInvoice(purchaseInvoiceReport.id)"
                > Cancel </button>
                <button type="button" style="display:none"
               class="btn btn-default btnCancelLoading" 
                > Cancel </button>
                </td>
...
export default {
  ...
  methods: {
    ...
    // ======================================================
        ...
        this.form.post("/purchaseReturnInvoiceApprove", {
            id: this.form.id,
...
deleteReturnInvoice(e){
        ...
        axios.get("/purchaseReturnInvoiceDelete/"+e).then((res) => {
            Toast.fire({
                    icon: "success",
...
setupInvoiceAmount(e){
        ...
        axios.get("/purchaseReturnInvoiceInfoPay/"+e).then((res) => {
    ...
    productSupplierList() {
      axios.get("/purchaseReturnInvoice").then((res) => {
        this.purchaseInvoiceReports = res.data.purchaseInvoiceReports;

        $('.btnApprove').show();
        $('.btnApproveLoading').hide();

        $('.btnCancel').show();
        $('.btnCancelLoading').hide();
    ...
    getPaginateList(page = 1) {
      axios.get("/purchaseReturnInvoice?page=" + page).then((response) => {
