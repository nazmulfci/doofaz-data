        ...
        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
          ...
          <tbody>
            ...
            >
              ...
              <!-- <td>{{ purchaseInvoiceReport.purchase_type.purchaseType }}</td> -->
...
export default {
  ...
  methods: {
    ...
    productSupplierList() {
      axios.get("/openingInvoiceReport").then((res) => {
    ...
    getPaginateList(page = 1) {
      axios.get("/openingInvoiceReport?page=" + page).then((response) => {
    ...
    viewInvoiceInfo(id) {
      let uri = 'getOpeningInvoiceInformation/'+id;
      axios.get(uri).then((response) => {
