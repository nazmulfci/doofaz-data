...
class CreatePurchaseProductUnitInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_product_unit_infos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_product_unit_infos');
    }
}
