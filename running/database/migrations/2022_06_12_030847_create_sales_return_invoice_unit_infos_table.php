...
class CreateSalesReturnInvoiceUnitInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_return_invoice_unit_infos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sales_return_invoice_unit_infos');
    }
}
