...
class CreateSalesReturnProductListTmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_return_product_list_tmps', function (Blueprint $table) {
            ...
            $table->double('unitPurchasePrice');
            $table->double('totalPurchasePrice');
    ...
    {
        Schema::dropIfExists('sales_return_product_list_tmps');
    }
}
