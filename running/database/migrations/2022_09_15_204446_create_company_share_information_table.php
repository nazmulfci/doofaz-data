...
class CreateCompanyShareInformationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_share_information', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('company_share_information');
    }
}
