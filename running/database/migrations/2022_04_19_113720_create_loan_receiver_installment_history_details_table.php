...
class CreateLoanReceiverInstallmentHistoryDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loan_receiver_installment_history_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('loan_receiver_installment_history_details');
    }
}
