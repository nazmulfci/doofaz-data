...
class CreatePurchaseProductUnitInfoTmpsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_product_unit_info_tmps', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_product_unit_info_tmps');
    }
}
