...
class CreateProviderLoanReceiveEntriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('provider_loan_receive_entries', function (Blueprint $table) {
            ...
            $table->boolean('paidStatus')->default('0');
    ...
    {
        Schema::dropIfExists('provider_loan_receive_entries');
    }
}
