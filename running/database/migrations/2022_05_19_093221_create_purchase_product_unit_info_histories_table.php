...
class CreatePurchaseProductUnitInfoHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_product_unit_info_histories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchase_product_unit_info_histories');
    }
}
