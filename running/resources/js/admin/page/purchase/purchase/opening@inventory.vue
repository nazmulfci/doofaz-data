<template id="">
    ...
    <div class="card">
      <form action="" @submit.prevent="addPurchaseInvoice()">
        <div
          ...
          "
        >
          <h3 style="color: black">Opening Inventory</h3>
        </div>
            ...
            <div class="col-auto pl-lg-auto purcha-border p-3">
              <div class="bg-white">
                <table class="table-hover mb-0">
                  ...
                  <tr>
                    <td class="title-name">  Invoice No </td>
                    <td>
                      <div>
                        <input
                          disabled
                      ...
                      <div class="" style="width:720px;">
                       ...
                       <table class="table table-bordered">
                         <tr v-for="advanceUnitSetupList in advanceUnitSetupLists">
                           ...
                           <td v-if="advanceUnitSetupList.totalUnitId"> <span
                                  ...
                                  <td> <button v-if="lastDbInsertId==advanceUnitSetupList.id" type="button" class="btn btn-danger" @click="deleteUnitSetup(advanceUnitSetupList.id)"> Delete </button> </td>
                         ...
                         <tr>
                           ...
                           <td>
                             <button type="button" @click="addAdvanceUnit()" class="btn btn-primary"> Add </button>
                           </td>
                         </tr>
                       ...
                       <table class="table table-bordered">
                         ...
                         <tr class="website1">
                           ...
                           <td>
                             <span for=""> Total Purchase Price  </span>
                             <br>
                                <input type="number"
                       ...
                       <div class="mt-4 p-2 bg-success">
                            <h6 class="text-center text-uppercase text-light"> Sales Price</h6>
                            <!-- Gradient divider -->
                       </div>
                       ...
                       <table class="table table-bordered">
                         ...
                         <tr class="website1">
                           ...
                           <td>
                             <span for=""> Total Sales Price  </span>
                             <br>
                                <input type="number"
                                step="0.000000000000001"
 ...
 <!-- ===================================== /Advance unit price setup -->
            ...
            <div class="col-12 float-right">
                  <span class="badge badge-danger productAddButtonTxt" style="display:none;float:right;">This Product Already Purchase</span>
                  <button
                    :disabled="loading"
                    type="submit"
                    class="btn btn-info float-right mr-2 mb-2 productAddButton"
                  >
                    <span
                      v-if="loading"
                      class="spinner-border spinner-border-sm"
...
axios.get('/advanceUnitSalesPriceUpdate/'+e+'/'+unitPrice).then(res => {
    ...
    deleteUnitSetup(e){
            axios.get('/advanceUnitSetupDeleteOpening/'+e+'/'+this.form.purchaseInvoiceNo).then(res => 
            {
...
changeAdvUnit(){
  ...
  this.form.adv_totalUnitId = this.form.adv_unitId;
    ...
    repurchaseProductInfoUnit(){
      ...
      $('.productAddButtonTxt').hide();

      this.form.quantity = '';
      
      this.form.post("/repurchaseProductOpeningUnit").then((res) => {
          
          if(res.data.purchase==1){
                      Toast.fire({
            icon: "error",
            title: "This product Already Purchase",
          });

          $('.productAddButton').hide();
          $('.productAddButtonTxt').show();
    ...
    ShowDataLists() {
      axios.get("/shopproductBrandEntry").then((res) => {
        ...
        this.brandLists = res.data.shopProductBrandList;
      });
    },
    shopTypeNameShow() {
    ...
    purchaseInvoiceNo() {
      axios.get("/openingInvoiceShow").then((res) => {
    ...
    productSupplierId(value) {
      ...
      axios
        ...
        .then((res) => {
          ...
          axios
            .get("getLastBalanceByAccCode/" + res.data.accountCode)
            .then((res) => {
    ...
    productList() {
      axios.get("/productListOpening").then((res) => {
    ...
    totalPurchaseValue() {
      axios
        .get("/totalPurchaseValueOpening/" + this.cusPurchaseInvoice)
        .then((res) => {
          let sum = 0;
          let quantity = 0;
          if(res.data.have==1){
          ...
          if (this.cusPreviousPayable > 0) {
            let totalcurrant =
              parseFloat(this.cusPreviousPayable) +
              parseFloat(this.form.totalProductCost);
            this.form.currentPayable = totalcurrant;
          }
          this.currentDue();
        });
