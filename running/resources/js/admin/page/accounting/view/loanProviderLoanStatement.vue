                    ...
                    <tbody>
                        ...
                        <tr v-for="(statementList1,index1) in companyStatementList1s">
                            ...
                            <td> Loan 
                              ...
                              <span v-if="statementList1.debitAmount==0"> Receive </span>
                              <span v-if="statementList1.debitAmount>0"> Pay </span>
                            ...
                            <td class="text-right"> 
                              ...
                              <!-- ============================= -->
                             <span v-if="statementList1.balanceAmount>=0" class="badge badge-danger">
                                {{statementList1.balanceAmount}}
                              </span>
                              <span v-else-if="statementList1.balanceAmount<0" class="badge badge-success">
...
export default {
  ...
  methods: {
    ...
    let uri = `getLoanProviderInfoLoanInfo/${this.$route.params.id}`;
    axios.get(uri).then((response) => {
    ...
    let uri = `getLoanProviderLoanReceiveInfo/${this.$route.params.id}`;
    axios.get(uri).then((response) => {
