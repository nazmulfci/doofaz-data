            ...
            <main>
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        ...
                        <div class="date"> Expense Title: {{ invoiceInfo.expenseTitle }}</div>
                    </div>
                </div>
                <table class="table table-bordered">
                    ...
                    <tbody v-if="have">
                        ...
                        <tr v-for="invoiceProductList,index in invoiceProductLists">
                            <td>{{++index}}</td>
                             ...
                             <td class=""> {{invoiceProductList.itemAmount}} </td>
                    ...
                    <tbody v-else>
                        <tr>
                            <td> 1 </td>
                            <td> {{ invoiceInfo.expenseTitle }} </td>
                            <td class="text-right"> {{ invoiceInfo.expenseAmount }} </td>
                    ...
                    <tfoot>
                        <tr> 
                            <td> </td>
                            <td> Grand Total </td>
                            <td> {{ invoiceInfo.expenseAmount }} </td>
                        </tr>
                        
                        
                        <tr> 
                            <td colspan="2"> 
                                <span v-if="invoiceInfo.paymentType==1"> Cash Pay </span>
                                <span v-else-if="invoiceInfo.paymentType==2"> Bank Pay</span>
                                 </td>
                             <td class=""> 
...
export default {
  ...
  methods: {
    ...
    let uri = `getExpenseInvoiceInformation/${this.$route.params.id}`;
    axios.get(uri).then((response) => {
