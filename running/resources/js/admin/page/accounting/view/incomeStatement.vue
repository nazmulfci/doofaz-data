...
getsubHeadCode() {
    ...
    getGeneralLadger() {
      ...
      axios.get(url)
        ...
        voucherSearch() {
            ...
            this.totalOrDaily = '('+moment(this.form.voucherDate).format("DD MMM YYYY")+' Income Statement) ';
          }else{ 
    ...
    showSubHeadCodeIncomeStatement(dat){
      $('.clk2ShowIncomeStatement-'+dat).toggle();
    },
    showSubHeadCodeIncomeStatementExpense(dat){
