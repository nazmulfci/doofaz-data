        ...
        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
            ...
            <tr>
                <th colspan="12" class="text-center"> 
                  <center>
                    <form method="" @submit.prevent="trialBalanceSearch()">
                      <table class="">
                        <tr>
                          <td> 
                                <select 
                            ...
                            v-if="mainHeadList.headCode==chartOfAccountList.headCode">
                           ...
                           <td> 
                            ...
                            v-if="subHeadList.headCode==chartOfAccountList1.headCode">
...
this.form.voucherNo = '';
      ...
      let url = "getMainHeadCodeForTrialBalance";
      axios.get(url)
        .then((response) => {
...
getsubHeadCode() {
      ...
      let url = "getHeadSubCodeByHeadcodeForTrialBalance/"+this.form.mainHead;
      axios.get(url)
        .then((response) => {
          this.form.subHead = '';
      ...
      axios.get(url)
        ...
        trialBalanceSearch() {
          ...
          if(this.form.voucherDate){
            this.totalOrDaily = '('+moment(this.form.voucherDate).format("DD MMM YYYY")+' Trial Balance) ';
          }else{ 
            this.totalOrDaily = '(Total Trial Balance) ';
          }
      
      let url = 'trialBalanceSearch';
    ...
    showSubHeadCodeTrialBalance(dat){
