...
<h4><i
          ...
          ></i>
          Statement of {{companyInformation.fullName}} </h4>
          </div>
            ...
            <main>
                <div class="row contacts">
                    <div class="col invoice-to">
                        ...
                        <h2 class="to"> {{ companyInformation.fullName }} </h2>
                        <div class="address"> {{ companyInformation.phoneNumber }} </div>
                        <div class="address">{{ companyInformation.presentAddress }}</div>
                        <div class="email">
                          <a 
...
export default {
  ...
  getInvoiceInformation() {
    ...
    let uri = `getEmployeeStatementInformation/${this.$route.params.id}`;
    axios.get(uri).then((response) => {
      this.companyInformation = response.data.employee;
