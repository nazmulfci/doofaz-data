            ...
            <tbody >
               <tr v-for="(shopBankAllData, index) in shopBankAllDatas">
                ...
                <td>{{ shopBankAllData.totalDue }}</td>
                  ...
                  <td>
                    <router-link :to="`/loanProviderGeneralLadger${shopBankAllData.id}`" 
                ...
                <td>
                    <router-link :to="`loanProviderVoucherList${shopBankAllData.id}`" 
                    class="btn btn-hover-shine  btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ul" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                    </svg>
                ...
                <td>
                    <router-link :to="`/loanProviderLoanList${shopBankAllData.id}`" class="btn btn-hover-shine  btn-primary"><i class=" fa fa-eye"></i> View </router-link>
               </td>
              </tr> 
            </tbody>
         </table>   
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                // addLoanProvider
                axios.get('/getLoanProviderWithLoanNpadiAmount')
                    .then(res => {
