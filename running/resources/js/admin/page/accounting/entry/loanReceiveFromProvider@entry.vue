   ...
   <span>
    <div class="card">
      <div class="card-header alert-info">
        <h3 style="color:black"> Loan Receive From Provider  </h3>
      </div>
          ...
          <form @submit.prevent="create()">
              ...
              <router-link :to="`/loanManagement`" class="btn btn-primary"> 
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 <label> Interest Type <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                
                <span v-if="haramStatus" class="badge badge-danger"> Its haram for muslim. </span>
                </label>
                 ...
                 <label> Loan Pay Type </label>
                  <select v-model="form.loanPayType" name="loanPayType" class="form-control" 
              ...
              <div class="form-group">
                 <label> Loan Amount <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                  ...
                  name="loanMainAmount" class="form-control" autocomplete="off"
                ...
                <div class="form-group" v-if="monthlyAmountStatus">
                 <label>   
                  ...
                  name="monthlyAmount" class="form-control" autocomplete="off"
                ...
                <div class="form-group" v-if="monthlyDateStatus">
              ...
              <div class="form-group">
                 <label> Payment Receive Type <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                </label>
