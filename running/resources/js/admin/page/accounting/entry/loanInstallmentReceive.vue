   ...
   <span>
    <div class="card">
      <div class="card-header alert-info">
        <h3> Loan Installment Receive </h3>
      </div>
            ...
            <form @submit.prevent="create()">
              ...
              <div class="form-group col-12">
                ...
                <div class="form-group col-12">
                 <label>   
                     Installment
                      Amount <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                </label>
                  <input type="text" v-model="form.installmentAmount"  
                  name="installmentAmount" @keyup="calculate" class="form-control" 
...
import moment from 'moment';
    export default {
        ...
        methods: {
            create() {
                this.loading = true;
                this.form.post('/addInstallmentFromReceiver').then(res => {
                    this.loading = false;
      ...
      if (!stringValue.match(regex) &&  this.form.installmentAmount !== "") {
       ...
       this.invalid = false;
            ...
            getProviderLoanInformation(){
                axios.get('/getLoanReceiverLoanInformation/1/'+this.form.loanProviderId).then(res => {
