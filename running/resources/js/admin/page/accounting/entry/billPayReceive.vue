.<template>
         ...
         <div class="col-lg-8 px-lg-5 col-sm-8 offset-sm-2 col-12 supplier-border comm-form-box-back-color">
            ...
            <div class="form-group" v-if="subHeadStatus">
              ...
              <has-error :form="form" field="subHead"></has-error>
                ...
                <div class="form-group">
                 <label> Balance <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i></label>
                ...
                <div class="form-group">
                 <label>  Amount <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i></label>
 ...
 <!-- ========================= payment option  -->
                ...
                <div class="form-group">
                    <label> Payment Type <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i></label>
    ...
    export default {
        ...
        methods: {
          clearForm(){
            ...
            create() {
                this.loading = true;
                this.form.post('/billPaymentReceiveForAll').then(res => {
                   this.loading = false;
                      Toast.fire({
                          icon: 'success',
