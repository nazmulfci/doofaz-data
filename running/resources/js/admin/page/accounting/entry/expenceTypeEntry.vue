            ...
            <tbody>
              ...
              >
                ...
                <td>
                    ...
                    v-if="chartOfAccount.headCode == accountSetupInfo.expenseType"
                    >
...
export default {
  ...
  methods: {
    ...
    addAccountsSetup() {
      this.loading = true;
      this.form.post("addExpenseType").then((response) => {
        this.loading = false;
