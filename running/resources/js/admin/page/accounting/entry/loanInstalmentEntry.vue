   ...
   <span>
    <div class="card">
      <div class="card-header alert-info">
         <h3 style="color:black"> Loan Instalment Pay </h3>
      </div>
          ...
          <form @submit.prevent="create()">
              ...
              <div class="form-group col-12">
                ...
                <div class="form-group col-12">
                 <label>   
                  ...
                  name="installmentAmount" class="form-control" autocomplete="off"
             ...
             <div class="text-right pt-3">
              ...
              >
                ...
                Submit</button>
               <button type="button" v-if="insufficent_button" class="mr-2 btn-pill btn-hover-shine btn btn-danger">
                Submit</button>
             </div>
          </form>
        </div>
...
import moment from 'moment';
    export default {
        ...
        methods: {
            create() {
              this.loading = true;
                this.form.post('/addInstallment').then(res => {
                  this.loading = false;
      ...
      if (!stringValue.match(regex) &&  this.form.installmentAmount !== "") {
       ...
       this.invalid = false;
            ...
            getProviderLoanInformation(){
                axios.get('/getLoanProviderLoanInformation/1/'+this.form.loanProviderId).then(res => {
