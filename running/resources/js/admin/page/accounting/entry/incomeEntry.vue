...
</svg> </router-link> Income Entry </h3>
      </div>
            ...
            <div class="col-lg-7 px-lg-5 col-sm-8 offset-sm-2 col-12 pb-2 pt-2 mb-3 supplier-border comm-form-box-back-color">
              ...
              <div class="form-group">
                 <label> Income Purpose 
                  ...
                  <select  v-model="form.incomePurpous" 
                ...
                <div class="form-group">
                 <label> Income Title </label>
                  <input type="text" v-model="form.incomeTitle"  
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered">
            <tr>
                ...
                <td> <input type="number"  min="0" class="form-control" placeholder="Amount" v-model="form.itemAmount"> </td>
                <td> <input type="button" class="btn btn-primary" value="Add" @click="incomeItemAdd(1)"> </td>
            </tr>
            ...
            <tr v-for="incomeDetailsList,index in incomeDetailsLists">
                <td> {{index+1}} </td>
                <td> {{incomeDetailsList.item}} </td>
                <td> {{incomeDetailsList.itemAmount}} </td>
                <td> <button type="button" @click="deleteIncomeDetailItem(incomeDetailsList.id)" class="btn btn-danger"> 
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" @click="incomeItemAdd(2)" data-dismiss="modal">Save changes</button>
      </div>
    </div>
  </div>
</div>
          ...
          <thead>
            ...
            <tbody>
              <tr v-for="(data,index) in datas">
                ...
                <td> 
                  <span v-for="incomePurposeList in incomePurposeLists" 
                      :value="incomePurposeList.id" 
                      v-if="data.incomePurpous==incomePurposeList.id"
                      > 
                      {{ incomePurposeList.incomePurpous }} 
                  </span>
                </td>
                <td> 
                  <span v-for="incomeCompanyList in incomeCompanyLists" 
                      :value="incomeCompanyList.id" 
                      v-if="data.incomeCompnayId==incomeCompanyList.id"
                      >
                      {{ incomeCompanyList.companyName }}
                      <br>
...
<script>
    export default {
        ...
        methods: {
            create() {
              this.loading = true;
                this.form.post('/addIncome').then(res => {
                   this.loading = false;
                      Toast.fire({
                          icon: 'success',
