<template id="">
    <span>
          ...
          <div class="col-md-2 numberList">
            ...
            <table style="width: 100%;" id="example" class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <td v-if="role==3">{{ shopInformation.create_by_name_show.userName }}</td>
                    <td>
                        <span>{{ shopInformation.area_information.areaName }}</span></td>
                    <td>
                        {{ shopInformation.shopOfficeName }} <br>
                        <button id="btn_form" @click.prevent="MessageModalShow(shopInformation.id)" class="btn-sm btn-pill btn-primary btn-hover-shine text-white">
                        Message
      ...
      <!-- <h4 v-if="dataInfo">hello data information</h4> -->
 ...
 import moment from 'moment';
  ...
  export default {
    ...
    methods: {
        ...
        view() {
            axios.get('dataInformationView1').then((response) => {
