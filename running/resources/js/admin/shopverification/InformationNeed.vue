    ...
    <div class="app-page-title">
      <div class="page-title-wrapper">
        <div class="page-title-heading">
          ...
          <div>
            Information Need
            <div class="page-title-subheading">Information Need</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="supplier-entry py-4 px-2">
        <div class="card-body table-responsive bg-white">
          ...
          >
            ...
            <tbody>
              <tr
                v-for="(shopInformation, index) in shopInformations"
                :key="shopInformation.shopInfoId"
              >
                <td>{{ ++index }}</td>

                <td>{{ shopInformation.shopName }}</td>
                <td>{{ shopInformation.userName }}</td>
                <td>{{ shopInformation.shopownerinfo.shopOwnerMobileNo }}</td>
                <td>{{ shopInformation.reason }}</td>
                <td>
                  <div>
                    <button
                      type="button"
                      ...
                      data-toggle="modal"
                      :data-target="'#' + 'details' + shopInformation.id"
                    >
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-6 col-12">
                                <div class="form-group">
                                  ...
                                  <span v-if="shopInformation.refferuser">
                                    {{ shopInformation.refferuser.name }}</span
                                  >
                                </div>
                          ...
                          <div
                            class="
                              ...
                              mt-5
                            "
                            v-for="address in saddress"
                            v-if="address.shopId == shopInformation.id"
                          >
                            <div class="row">
                              <div class="col-12">
              ...
              <has-error :form="form" field="currencyId"></has-error>
                                ...
                                <div class="form-group">
                                  ...
                                  <span v-if="address.district">
                                    {{ address.district.district_name }}</span
                                  >
                                </div>
                                ...
                                <div class="form-group">
                                  <label>
                                    ...
                                    ></i
                                  ></label>
                                  <span v-if="address.union">
                                    {{ address.union.union_name }}</span
                                  >
                                </div>
                              ...
                              <div class="col-lg-6 col-12">
                                ...
                                <div class="form-group">
                                  <label>
                                    ...
                                    ></i
                                  ></label>
                                  <span v-if="address.thana">
                                    {{ address.thana.upazila_name }}</span
                                  >
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <span v-if="address.ward">
                                    {{ address.ward.ward_name }}</span
                                  >
                                </div>
                ...
                <td>
                  <div v-if="shopInformation.informationNeedStatus==0">
                    <span class="badge badge-warning">Wating</span>
                  </div>
                  <div class="dropdown" v-else>
                    <button class="dropbtn">
                      <i class="fa fa-cogs" aria-hidden="true"></i> Select One
                    </button>
                    <div class="dropdown-content">
                      <a
                        href="#"
                        data-toggle="modal"
                        :data-target="'#' + 'verify' + shopInformation.id"
                        >Veryfied Shop</a
                      >
                      <a
                        href="#"
                        data-toggle="modal"
                        :data-target="'#' + 'pending' + shopInformation.id"
                        >Pending</a
                      >
                      <a
                        href="#"
                        data-toggle="modal"
                        :data-target="'#' + 'cancel' + shopInformation.id"
                        >Cancel</a
                      >
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button
                            type="button"
                            class="btn btn-primary"
                            @click.prevent="pending(shopInformation.id)"
                          >
                            Save changes
                          </button>
                        </div>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button
                            type="button"
                            class="btn btn-primary"
                            @click.prevent="cancel(shopInformation.id)"
                          >
                            Save changes
                          </button>
                        </div>
...
export default {
  ...
  methods: {
    ...
    pending(id) {
      axios
        .post(`shopVerificationPending/${id}`, { reason: this.reason })
    ...
    cancel(id) {
      axios
        .post(`cancelShopStatus/${id}`, { reason: this.reason })
    ...
    informationNeed(id) {
      axios
        .post(`informationNeedStatus/${id}`, { reason: this.reason })
        .then((response) => {
          Toast.fire({
            icon: "success",
