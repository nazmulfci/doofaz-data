          ...
          <tbody>
            ...
            >
              ...
              <td> 
                ...
                <button v-if="loading" class="btn btn-primary mb-5">
                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                   Approve  </button>

                <button v-else class="btn btn-primary mb-5" @click="billApprove(billRequestList.id)">
                <span  class="mr-2 opacity-7"><i class="fa fa-paper-plane"></i></span>
                   Approve  </button>

                
                <button class="btn btn-danger mb-5" @click="billCencle(billRequestList.id)"> Cencle </button>
                 </td>
...
<script>
  ...
  mounted() {
    ...
    this.shopBillMonthList();
      ...
      methods: {
        view(){
           axios.get('/shopBillRequestListAdmin/').then(res => {
