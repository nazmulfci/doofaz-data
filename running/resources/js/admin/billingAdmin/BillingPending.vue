...
Select One</button>
  <div class="dropdown-content">
    ...
    <a href="#"  @click.prevent="cancel(shopInformation.id)">Cancel</a>  
    <a href="#"  @click.prevent="delivered(shopInformation.id,shopInformation.userName)">Deliverd</a>
  </div>
</div>   
...
<!-- <div class="modal fade" :id="'deliverd'+shopInformation.id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
     <div class="form-group">
            <label for="message-text" class="col-form-label">Existing Url:</label>
            <input type="text" class="form-control" :value="shopInformation.existingUrl" id="message-text"/>
          </div>
     <div class="form-group">
            <label for="message-text" class="col-form-label">New Url:</label>
            <input type="text" class="form-control" v-model="refferUrl" id="message-text"/>
          </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" @click.prevent="delivered(shopInformation.id,shopInformation.userName)">Save changes</button>
      </div>
    </div>
  </div>
</div>  -->
...
export default {
  ...
  delivered(id,name){   
      ...
      axios.post(`deliveredBillingStatus/${id}`)     
        .then((response) => {
          Toast.fire({
                icon: 'success',
