          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              >
                ...
                <option
                  v-for="wardList,index in wardLists"
                  :key="wardList.id"
                  :value="wardList.id"
                >{{++index}},
                  {{ wardList.ward_name }}
            ...
            <div class="form-group">
              <label> Business Currency <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i>
                 </label>
 ...
 this.shops=false;
  ...
  alertRate(){
    ...
    this.loading=true;
      ...
      this.form.post("shopInformation").then((response) => {
  ...
  if(this.form.refferType==2){
    
        this.form.post("https://portal.safejob.net/api/newShopStore").then((response) => {
