            ...
            <tbody v-for="list in lists" :key="list.id">
              ...
              <tr v-for="(shopInformation, index) in shopInformations" :key="shopInformation.shopInfoId" v-if="list.shopId==shopInformation.id">
                ...
                <td>
                  ...
                  <!-- Modal -->
<div class="modal fade" :id="'modalTrainer'+shopInformation.id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Trainer Details Information</h5>
      ...
      <div class="modal-body">
        ...
        >
          ...
          <span v-for="lit in employeeLIsts" v-if="list.trainerId==lit.id">    {{ lit.name }}</span>
            </div>
  ...
  <span v-for="lit in employeeLIsts" v-if="list.trainerId==lit.id">    {{ lit.mobile }}</span>
            </div>
            ...
            <div class="form-group">
              <label> Email:
                 <!-- <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i> -->
                  ...
                  <span v-for="lit in employeeLIsts" v-if="list.trainerId==lit.id">    {{ lit.email }}</span>
            </div>
          ...
          <!------------------   ----------------------->
            ...
            <!-- </div>               -->
                  ...
                  <span class="badge badge-info" data-toggle="modal" :data-target="'#'+'modalTrainer'+shopInformation.id"><span  v-for="lit in employeeLIsts" v-if="list.trainerId==lit.id">{{ lit.name }}</span></span></td>
                <td>{{ list.tDate }}</td>
                <td>{{ list.tTime}}</td>
...
Select One</button>
  <div class="dropdown-content">
    ...
    <router-link
                  ...
                  >
                  <a href="#"  @click.prevent="success(shopInformation.id)">Success</a>
  </div>
</div>   
                </td>
