        ...
        <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
            ...
            <tbody>
              <tr v-for="(shopInformation, index) in shopInformations" :key="shopInformation.shopInfoId">
                <td>{{ ++index }}</td>
                <td>{{ shopInformation.created_at }}</td>
...
<div class="modal fade" :id="'details'+shopInformation.id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
       ...
       <!-- ===================================================================== -->
        ...
        >
          ...
          <div class="row">
            ...
            <span v-if="shopInformation.shopcontactpersion">   {{shopInformation.shopcontactpersion.CPName}}</span>
            </div>
            ...
            <span v-if="shopInformation.shopcontactpersion">     {{shopInformation.shopcontactpersion.CPMobileNo}}</span>
            </div>
            ...
            <span v-if="shopInformation.shopcontactpersion">    {{shopInformation.shopcontactpersion.CPEmail}}</span>
            </div>
          ...
          <!------------------   ----------------------->
            ...
            <span v-if="shopInformation.shopcontactpersion">     {{shopInformation.shopcontactpersion.CPAddress}}</span>
            </div>
            ...
            <span v-if="shopInformation.shopcontactpersion">   {{shopInformation.shopcontactpersion.CPPhoneNo}}</span>
            </div>
       ...
       <!-- ===================================================================== -->
        ...
        >
          ...
          <div class="row">
            ...
            <span v-if="shopInformation.shoprepresentative">   {{shopInformation.shoprepresentative.SRName}}</span>
            </div>
            ...
            <div class="form-group">
              ...
              <span v-if="shopInformation.shoprepresentative">    {{shopInformation.shoprepresentative.SRMobileNo}}</span>
            </div>
            ...
            <div class="form-group">
              ...
              <span v-if="shopInformation.shoprepresentative">   {{shopInformation.shoprepresentative.SREmail}}</span>
            </div>
          ...
          <span v-if="shopInformation.shoprepresentative">      {{shopInformation.shoprepresentative.SRAddress}}</span>
            </div>
            ...
            <div class="form-group">
              <label>  Phone No
                 <!-- <i class="fa fa-star text-danger text-10 cursor-pointer" title="Mendatory Field" data-placement="top" data-toggle="tooltip" data-original-title="Mendatory Field"></i> -->
                   ...
                   <span v-if="shopInformation.shoprepresentative">    {{shopInformation.shoprepresentative.SRPhoneNo}}</span>
            </div>
 ...
 {{address.right}}
   ...
   <router-link
                  ...
                  ><i class="fa fa-edit"></i> Create Training </router-link
                  >
                </td>
...
export default {
  ...
  pending(id){
      ...
      axios.get(`shopVerification/${id}/edit`)
  ...
  informationNeed(id){    
      axios.get(`informationNeedStatus/${id}`)     
        .then((response) => {
            Toast.fire({
                icon: 'success',
  ...
  delivered(id){    
      axios.get(`deliveredShopStatus/${id}`)     
        .then((response) => {
            Toast.fire({
                icon: 'success',
