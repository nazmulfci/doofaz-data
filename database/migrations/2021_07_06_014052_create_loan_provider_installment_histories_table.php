...
class CreateLoanProviderInstallmentHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('loan_provider_installment_histories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('loan_provider_installment_histories');
    }
}
