...
class CreateBillPaymentReceivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bill_payment_receives', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bill_payment_receives');
    }
}
