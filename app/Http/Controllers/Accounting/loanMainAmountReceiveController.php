...
class loanMainAmountReceiveController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //   'headGroupType.required' => 'Enter Group Type',
            ...
            $particular = "Loan Main Amount Pay Mr/Mrs $providerName";
        ...
        if($request->loanPayTypeId == 2){
            ...
            $dueAmount = $request->loanDueAmount-$request->installmentAmount;
        }else{
            $totalPaidAmount=$request->installmentAmount;
            $dueAmount = $request->loanDueAmount-$request->installmentAmount;
        }
                ...
                LoanReveiverInstallmentHistory::insert([
                  ...
                  LoanReceiverInstallmentHistoryDetails::insert([
                        ...
                        'paymentType' => $request->paymentType,
                        'debitAmount' => 0,
                        'creditAmount' => $request->installmentAmount,
