...
class incomeEntryController extends Controller
{
    ...
    public function incomeTypeList(){
        $code = AccountSetup::where('placementType',24)->where('headName',102)->first()->headCode;
        $select = ChartOfAccount::where('headGroupType','3')->where('headCode','LIKE',"$code%")->get();
        $incomeType = ChartOfAccount::where('headGroupType','3')->where('headCode','LIKE',"$code%")->first()->headCode;
        return [
            'data' => $select,
    ...
    public function getIncomeHeadList($id){
        $data = IncomeType::where('accountHeadCode',$id)->get();
        $id = IncomeType::where('accountHeadCode',$id)->first()->id;
    ...
    public function store(Request $request)
    {
        ...
        // ============================================
            ...
            IncomeType::insert([
                  ...
                  'accountCode' => $accCode,
                  'incomeType' => $request->expenseType,
