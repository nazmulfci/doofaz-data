...
class AdminRefferTempController extends Controller
{
    /**
    ...
    {
        $shops = AdminRefferTemps::get()->toJson(JSON_PRETTY_PRINT);
    ...
    public function store(Request $request)
    {
        ...
        $ShopInformation = new AdminRefferTemps();
        ...
        $ShopInformation->refferTypeId = 1;
        ...
        $args = http_build_query(array(
            ...
            'msg'  => 'New Shop Registred From Reffer Registration.Shop Name='.$shopName.',Mobile='.$request->get('shopOwnerMobileNo')));
    ...
    //   $getBranchBillAmount = ShopBillingAmount::where('billType', 1)->first()->billAmount;
      ...
      $ShopInformation->registredForm = 2;
      $ShopInformation->haveBranch = $haveBranch;
      $ShopInformation->totalBranch = $totalBranch;
      $ShopInformation->countryId = $countryId;
      $ShopInformation->currencyId = $currencyId;
  ...
  $ShopAddressLocation->save();
    ...
    AdminRefferTemps::where('userName', $email )->delete();
        return response()->json([
            "message" => "Shop record created"
        ], 201);
      }
    ...
    {
      $show=AdminRefferTemps::where('id',$id)->first();
